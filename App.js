...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card" style={{
            ...
            <img className="res-logo" alt-name="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} />
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
            <h4>{costForTwo}</h4>
...
const resList= [
    ...
    "availability": {
    "nextCloseTime": "2023-10-03 00:28:00",
    "opened": true
    },
    "badges": {},
    "isOpen": true,
    ...
    "availability": {
    "nextCloseTime": "2023-10-03 02:45:00",
    "opened": true
    },
    "badges": {
    "textExtendedBadges": [
    ...
    "availability": {
    "nextCloseTime": "2023-10-03 03:55:00",
    "opened": true
    },
    "badges": {},
    "isOpen": true,
    ...
    "availability": {
    "nextCloseTime": "2023-10-02 20:00:00",
    "opened": true
    },
    "badges": {
    "imageBadges": [
